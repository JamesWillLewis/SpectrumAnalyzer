...
/**
 * Highly optimized and tuned implementation of the Branch-and-Bound algorithm with
 * best-first-search to solve a knapsack problem - selecting the optimum set of items 
 * from a larger set, that maximizes the total value and is within the constraints 
 * of the maximum allowed weight(spectrum bandwidth). 
 * The tests have shown that this implementation can perform within acceptable
 * time on hundreds of items, using randomly generated test samples.
 * 
 * @author James Lewis
 */
public class KnapsackAlgorithm {
    ...
    public KnapsackAlgorithm(List<Bid> bids, double capacity) {
        //initialization
    ...
    public List<Bid> bestFirstBranchAndBound() {
        ...
        System.out.println("Auction allocation complete...");
        ...
        System.out.println("Number of winning bids: " + bestItems.size());
